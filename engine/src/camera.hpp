...
namespace triton
{
    ...
    public:
        ...
        void Update(const cVector2& screenCursorPosition, types::usize screenWidth, types::usize screenHeight, types::f32 zNear, types::f32 zFar, types::f32 mouseSensitivity);
