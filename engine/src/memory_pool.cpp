...
triton::cMemoryAllocator::~cMemoryAllocator()
{
	if (_bins)
	{
...
void* triton::cMemoryAllocator::Allocate(types::usize byteSize, types::usize alignment)
{
...
void triton::cMemoryAllocator::Deallocate(void* ptr)
{
	if (ptr == nullptr)
		return;
